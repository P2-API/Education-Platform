...
import { Education, MinimumMaximum } from '../../src/types.ts';
...
const DataTableSection: React.FC<DataTableSectionProps> = ({ setIsModalOpen, possibleEducations }) => {
    // Enum Lists
    ...
    return (
        <div style={{ display: "flex", height: "80%", padding: 0 }}>
