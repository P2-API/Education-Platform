    ...
    return (
        <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", height: "5em"}} >
            ...
            <ul style={{display: "flex", justifyContent: "space-between", width: "25%", minWidth: "400px"}}>
                ...
                <li style={{marginLeft: "1em", marginRight: "1em", color: path === '/about' ? "#006eff" : undefined}}>
                    <Link to="/about">Om siden</Link>
                </li>
                <li style={{marginLeft: "1em", marginRight: "1em", color: path=== '/' ? "#006eff" : undefined}}>
                    <Link to="/">Uddannelser</Link>
                </li>
                <li style={{marginLeft: "1em", marginRight: "1em", color: path === '/methods' ? "#006eff" : undefined}}>
