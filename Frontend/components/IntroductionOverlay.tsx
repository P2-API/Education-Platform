    ...
    return (
        <div style={{ height: "100vh", width: "100%", backgroundColor: "#f8fbff" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh" }}>
                ...
                <p style={{ fontSize: "1.2em", maxWidth: "80%", textAlign: "center" }}>Den anden side er en visualiseringsside hvor 3 forskellige visualiseringer kan vælges. Her findes PCA analysen som viser hvor relaterede uddannelserne er på hinanden, på baggrund af alle faktorer.<br />Derudover kan en bar graf og en radar graf vælges, til at sammenligne forskellige uddannelser på selvvalgte faktorer</p>
                <p style={{ fontSize: "1.2em", maxWidth: "80%", textAlign: "center" }}>Efter du har valgt dine filtre og prioriteter, samt beregnet rangeringen af uddannelserne, kan du ved at udvide en række i tabellen få en personlig forklaring på, hvorfor uddannelsen ikke lever op til dine krav, eller hvorfor en uddannelse passer specielt godt til dig baseret på dine valg.</p>
